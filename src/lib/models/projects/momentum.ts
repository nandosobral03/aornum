...
export const momentum: ProjectDetails = {
    name: "Momentum",
    links: [
        {
    ...
    description: `
             Momentum is a web application that allows you to track your habits, set goals, and visualize your progress. It is designed to help you build good habits and break bad ones. The premise is simple: instead of setting single habits you want to get to, you create a list of habits you want to track. You can then track your progress over time and see how you are doing. These lists can be either public or private, allowing others to subscribe to the same habits as you and work through them together.
            <br>
            ...
            <br>
            As well as tracking your habits, you can create and subscribe to challenges. These are structured sets of goals with a defined time duration and a set of rules. Challenges have to be completed one stage at a time, and you can only move on to the next stage once you have completed the current one.
            <br>
            Once challenges are completed or habit lists are completed for a given time period, you can see a visual representation of your progress in the badges displayed on your profile. Next to some information the user might want to share with the community.
            <br>
            Everything is designed to be as simple and easy to use as possible, with the aim of making it as easy as possible to build good habits. All tasks assigned for the day are displayed on the home page where the user can mark them as completed or not, easily keeping track of their progress.
            
    `,
    technologies: `
        Momentum was created using Next.js and felt like a stepup from my previous project, nochan. I was able to use Next.js' server side rendering, using cookies to fetch the data as the user and rendering all posts, identifying those made by the user serverside. 
        Making the website feel more responsive and faster. I'm also using Next.js' API routes to handle the backend, which is a great way to handle the backend of a Next.js project which is something I hadn't done before. 

        <br>
        The business logic of the project is handled using tRPC which allowed me to create a type safe connection between the frontend and the backend. This way I could move fast and not have to worry about the frontend and backend being out of sync. I also used Prisma to handle the database, which was a great experience, I found it to be very easy to use and better than the other ORMs I've used in the past and will continue to use it in the future for my projects.
        <br>
        For the Auth I opted for Auth.js (formerly NextAuth.js) which was a great experience, it was very easy to use and I was able to get it up and running in no time. Making this implementation far safer than my previous projects and allowed me to setup multiple SSO providers with ease.
    ...
    thingsLearned: `
        ...
        I also learned about tRPC which allowed me to create a type safe connection between the frontend and the backend. This way I could move fast and not have to worry about the frontend and backend being out of sync. I also used Prisma to handle the database, which was a great experience, I found it to be very easy to use and better than the other ORMs I've used in the past and will continue to use it in the future for my projects.
    `,
