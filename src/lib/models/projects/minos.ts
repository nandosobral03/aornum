...
export const minos: ProjectDetails = {
    name: "Minos",
    links: [
        {
    ...
    description: `
        Minos is a visualizer for different pathfinding algorithms. It allows you to create a grid and place
        a starting point, one or more end points and obstacles. Then you can select an algorithm and it will
        show you how it works. You can see the nodes it visited and the path it took to get to the end point.
        <br><br>
        I created this project because I wanted to touch up on my pathfinding algorithm knowledge and I thought
        this would be a fun way to do it. I also wanted to learn more about how to create a visualizer and how
        to make it look good.
        <br><br>
        Minos also comes with an about page that explains how the different nodes in the grid work and how the
        the different algorithms work. Each algorithm has 3 different explanations, each increasing in complexity.
        Each algorithm also comes with the typescript code that runs it, each section of the code is commented
        explaining what it does.
        <br><br>
        The project is live and hosted on <a href="http://minos.aornum.xyz/visualizer" target="_blank">minos.aornum.xyz</a> but
        it is not mobile responsive so I only recommend using it on a desktop.`,
    technologies: `
