...
export const fourCombinator: ProjectDetails = {
	name: '4combinator',
	links: [
		{
	...
	technologies: `
        ...
        <br>
        The project was deployed with Vercel, as usual it was easy and fast since Next is the bread and butter of the platform. The database I went with something new, I used <a href="https://turso.tech/">Turso</a> for the database, it uses libsql which is a fork of sqlite. The experience so far has been great, coming out of mushare I had pretty much the same problems at the time of setting up the database but I already knew how to fix it so it was a breeze. The purpose of a database in this project is mainly to use it as a cache for the 4chan API, since the API is public and doesn't require any authentication the 4chan API kindly asks to not abuse the API and not make too many requests per minute so this way we can play fair with everyone accessing the service.
        <br>
