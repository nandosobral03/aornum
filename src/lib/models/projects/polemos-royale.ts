...
export const polemosRoyale: ProjectDetails = {
	name: 'Polemos Royale',
	links: [
		{
	...
	description: `
        Polemos Royale is a remake of my previous project, Polemos, like the first implementation, Polemos Royale is a text based battle simulator inspired by <a href="https://brantsteele.net/hungergames/"> BrantSteele's Hunger Games Simulator</a>. The idea is the same as before, have a cast of user-selected characters and run a simulation to see who comes out on top, while reading the twists and turns of the story that unfolds.
        <br><br>
        Polemos Royale is a remake of the original project, distilling the idea to it's core components and building upon them. This time features like authentication, user management, and more were stripped away, focusing on the core functionality of the project. Once I felt like the implementation of the core features was solid and reflected what I wanted to achieve, I started adding new features, the main difference with this implementation and all previous ones is the addition of what we call <i>locations</i> these locations come in 2 types, "tiles" and "hazards". The idea behind this addition is to attach events to locations and have the simulation work with that instead of having a never ending array of events that can happen at any time. This we can mold the story to our liking, having each game be unique. <a href="https://engineering.atspotify.com/2014/02/how-to-shuffle-songs/">Much like how spotify realised that people don't want true randomness in their playlists </a> we realised that we didn't want true randomness in our simulations, it often lead to events repeating themselves or anticlimatic endings. Locations are our way of controlling the flow of the simulation and removing the bad parts of 100% randomness, while leaving the uncertainty that makes the simulation fun.
        <br><br>
        ...
        `,
	technologies: `
        For this project, I continued using Next.js as the main framework, which has proven to be an excellent choice for rapid development and iteration. Tailwind CSS once again employed for styling, opting for <a href="https://ui.shadcn.com/" target="_blank">Shadcn</a> as the component library to speed up the development process.
        <br>
